...
foreign import ccall "OISInputManager.h OIS_InputManager_createInputObject" c_inputManager_createInputObject :: InputManager -> CInt -> CBool -> Std__string -> IO Object
inputManager_createInputObject :: InputManager -> Type -> Bool -> Std__string -> IO Object
inputManager_createInputObject p1 p2 p3 p4 =   c_inputManager_createInputObject p1 (typeToCInt p2) (fromBool p3) p4
