...
foreign import ccall "OISKeyboard.h OIS_Keyboard_copyKeyStates" c_keyboard_copyKeyStates :: Keyboard -> CChar -> IO ()
keyboard_copyKeyStates :: Keyboard -> Char -> IO ()
keyboard_copyKeyStates p1 p2 =   c_keyboard_copyKeyStates p1 (castCharToCChar p2)
